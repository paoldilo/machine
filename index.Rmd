...
The accuracy of the Random Forest o is `r accu_list[2,1]*100`%  and the out of sample error using cross-validation is `r outOfSampleError`% that is quite small and reliable so I will use the trained random forest as the predicting model.
